...
public class Main {
    ...
    public static void listarRazaMain() {
    ...
    public static void listarPersonajes_EventosMain() {
    ...
    public static void listarEventosMain() {
    ...
    public static void listarPersonajesMain() {
    ...
    public static void listarLugaresMain() {
    ...
    public static void insertRazas() {
    ...
    public static void insertLugares() {
    ...
    public static void insertPersonajes() {
    ...
    public static void insertEvento() {
        System.out.printf("Siguele luego");
    }
